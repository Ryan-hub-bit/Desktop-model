        ...
        for i in range(len(randomlist)):
            ...
            if num%50 == 0:
                ...
                if bestf1 <f1[-1]:
                    bestf1 = f1[-1]
                    th.save(
                        model.state_dict(), os.path.join(savePATH, "model.checkpoint")
                    )
...
if __name__ == "__main__":
    ...
    exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/datanodeedgecode',
            Revedges = False, Adddata = True, Addfunc = False, DataRefedgs = True, Calledges = False, CodeRefedgs = True, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/allpe',
    #         Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/alloff',
    #         Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/revedges',
    #         Revedges = True, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/adddata',
    #         Revedges = False, Adddata = True, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/addfunc',
    #         Revedges = False, Adddata = False, Addfunc = True, DataRefedgs = False, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/DataRefedgs',
    #         Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = True, Calledges = False, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/Calledges',
    #         Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = True, CodeRefedgs = False, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/codeRefedgs',
    #         Revedges = False, Adddata = False, Addfunc = False, DataRefedgs = False, Calledges = False, CodeRefedgs = True, Laplacian_pe=False)
    # exp_all(epochs = epochs, hidden_features=hidden_features, savePATH = '/home/isec/Desktop/model/compareExperiment/allafter',
    #         Revedges = True, Adddata = True, Addfunc = True, DataRefedgs = True, Calledges = True, CodeRefedgs = True, Laplacian_pe=False)
'''
